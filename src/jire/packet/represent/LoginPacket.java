...
public final class LoginPacket implements PacketRepresentation {
	...
	private LoginPacket(int magic, int clientVersion, boolean lowDetail,
			int[] fileChecksums, int blockLength, int blockOperationCode,
			int[] sessionKeys, int userId, String username, String password) {
		this.magic = magic;
	...
	public static LoginPacket get(int magic, int clientVersion,
			boolean lowDetail, int[] fileChecksums, int blockLength,
			int blockOperationCode, int[] sessionKeys, int userId,
